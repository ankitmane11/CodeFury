...
<body>
	<div class="bg-image">
		<table border="5px" style="margin-left: 400px; margin-top: 100px;">
			...
			<tr>
				<td style="padding: 10px; font-size: 40px;">Test Values :</td>
				<td id="email" style="padding: 10px; font-size: 40px;"></td>
			</tr>
			<tr>
				<td style="padding: 10px; font-size: 40px;">Test Values :</td>
				<td id="role" style="padding: 10px; font-size: 40px;">Test
					Value</td>
			</tr>
			<tr>
				<td style="padding: 10px; font-size: 40px;">Test :</td>
				<td id="login" style="padding: 10px; font-size: 40px;">Test
					Values</td>
			</tr>
