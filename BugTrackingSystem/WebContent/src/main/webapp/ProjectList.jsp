                        ...
                        <div>
                            <table>
                                ...
                                <tr> 
                                    ...
                                    <td>
                                    <input type="text" id="projectName" placeholder="Enter ProjectName" name="projectname" required="required"> 
                                </td>
                                </tr>
                                ...
                                <td>
                                    <input type="text" placeholder="Description" id="description" name="description" required="required"> 
                                </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <td>
                                    <input type="text" placeholder="Project" id="Project Manager" name="projectmanager" required="required"> 
                                </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <td>
                                    <input type="text" placeholder="teamMembers" id="teamMembers" name="teamMembers" required="required"> 
                                </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <td>
                                    <input type="date" placeholder="Enter" id="startDate" name="startdate" required="required"> 
                                </td>
                                </tr>
