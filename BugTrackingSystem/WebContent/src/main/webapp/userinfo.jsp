<%@ page language="java" import="com.app.beans.User" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"%>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="inner">
        ...
        <nav>
            ...
            <a> is the actual clickable part -->
                ...
                <ul>
				  <li><span><a href="userinfo.jsp" class="button">User Information</a></span></li>
    ...
    <div class="bg-image">
        <table border="10px" style="margin-left:450px;margin-top:150px;">
            ...
            <tr>
               ...
               <td id="email" style="padding:10px; font-size:40px;"><%=u.getEmail()%></td>
             </tr>
             <tr>
                <td style="padding:10px; font-size:40px;">Role :</td>
                <td id="role" style="padding:10px; font-size:40px;">Manager</td>
             </tr>
